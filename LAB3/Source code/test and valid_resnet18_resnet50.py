...
def main():
    ...
    model_names = ['resnet_18', 'resnet_50']
    valid_loader = DataLoader(LeukemiaLoader('valid',None), batch_size=64, shuffle=False)
    ...
    for model_name in model_names:
        ...
        test_loader = DataLoader(LeukemiaLoader('test',model_name), batch_size=64, shuffle=False)
